  ...
  return (
    <div className={style.home}>
      <div className={style.home_container}>
        <div className={style.home_logo_area}>
          <img
            src="/logoIndex.jpeg"
            alt="logoHome"
            className={style.homeIndex}
          />
          <h1>SuperAhorro</h1>
        </div>
        ...
        <form className={style.home_form} onSubmit={handleSubmit}>
          <input
            type="text"
            id="findSearch"
            className={style.home_form_input}
          ...
          <div className={style.home_form_select}>
            ...
            <select
              name="membership"
              className={style.home_form_select_box}
              id="membership"
            >
          ...
          <button className={style.home_form_button} type="submit">
            Buscar
          </button>
        </form>
      </div>
